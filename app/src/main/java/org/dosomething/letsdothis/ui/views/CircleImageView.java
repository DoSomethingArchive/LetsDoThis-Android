...
public class CircleImageView extends ImageView
{
    ...
    private boolean mDefaultConfig = false;
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        mDrawRadius = a.getBoolean(R.styleable.CircleImageView_draw_border, DEFAULT_DRAW_BORDER);
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleImageView_border_width,
                                               DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.CircleImageView_border_color, DEFAULT_BORDER_COLOR);
        mBackgroundColor = a.getColor(R.styleable.CircleImageView_background_color,
                                      getResources().getColor(R.color.white));
        mIsPlaceholder = a.getBoolean(R.styleable.CircleImageView_placeholder, false);
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        if(isDrawBorder() && mBorderWidth > 0)
        {
            canvas.drawCircle(getWidth() / 2, getHeight() / 2, mBorderRadius - getPaddingLeft() - 1,
                              mBorderPaint);
        }
    }
    ...
    public void setDrawBorder(boolean drawRadius)
    {
        mDrawRadius = drawRadius;
    ...
    public void userDefaultConfig(boolean defaultConfig)
    {
        mDefaultConfig = defaultConfig;
        invalidate();
    }

    public void setBackgroundPlateColor(int color)
    {
    ...
    public int getBackgroundPlateColor()
    {
